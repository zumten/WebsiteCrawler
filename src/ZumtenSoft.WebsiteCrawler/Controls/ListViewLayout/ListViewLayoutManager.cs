...
namespace ZumtenSoft.WebsiteCrawler.Controls.ListViewLayout
{
	...
	public class ListViewLayoutManager
	{
		...
		private void InitColumns()
		{
			...
			{
                if (FixedColumn.IsFixedColumn(gridViewColumn))
                {
                    double? width = FixedColumn.GetFixedWidth(gridViewColumn);
                    if (width.HasValue)
                    {
                        gridViewColumn.Width = width.Value;
                    }
                }
